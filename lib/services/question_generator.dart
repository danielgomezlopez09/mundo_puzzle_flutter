...
class QuestionGenerator {
  ...
  static Map<int, Map<String, dynamic>> _ageRanges = {
  ...
  static Question generateQuestion(int playerAge, String questionId) {
    ...
    final min = ageConfig['min'] as int;
    final max = ageConfig['max'] as int;
    final operations = ageConfig['operations'] as List<String>;
    ...
    return Question(
      ...
      educationalLevel: ageConfig['name'] as String,
      topic: operation,
    );
  }
